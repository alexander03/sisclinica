...
<script>
	...
	function imprimirReporte(){
        window.open("garantia/pdfReporte?doctor="+$(IDFORMBUSQUEDA + '{{ $entidad }} :input[id="nombre"]').val()+"&paciente="+$(IDFORMBUSQUEDA + '{{ $entidad }} :input[id="paciente"]').val()+"&fechafinal="+$(IDFORMBUSQUEDA + '{{ $entidad }} :input[id="fechafinal"]').val()+"&fechainicial="+$(IDFORMBUSQUEDA + '{{ $entidad }} :input[id="fechainicial"]').val()+"&situacion="+$(IDFORMBUSQUEDA + '{{ $entidad }} :input[id="situacion"]').val(),"_blank");
    }

    function generaExcel(){
        window.open("garantia/ExcelReporte?doctor="+$(IDFORMBUSQUEDA + '{{ $entidad }} :input[id="nombre"]').val()+"&paciente="+$(IDFORMBUSQUEDA + '{{ $entidad }} :input[id="paciente"]').val()+"&fechafinal="+$(IDFORMBUSQUEDA + '{{ $entidad }} :input[id="fechafinal"]').val()+"&fechainicial="+$(IDFORMBUSQUEDA + '{{ $entidad }} :input[id="fechainicial"]').val()+"&situacion="+$(IDFORMBUSQUEDA + '{{ $entidad }} :input[id="situacion"]').val(),"_blank");
    }
