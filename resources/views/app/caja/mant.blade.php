...
function transferencia(valor){
    if(valor==7 || valor==8 || valor==16 || valor==14 || valor==18 || valor==20 || valor==31 || valor==45){ 
        ...
        }else if(valor==8 || valor==45){//PAGO A DOCTOR
            $("#divDocs").css("display","");
            $("#divPersona").css("display","none");
    ...
    if(valor==10 || valor==7 || valor==8 || valor==16 || valor==14 || valor==20 || valor==45){
