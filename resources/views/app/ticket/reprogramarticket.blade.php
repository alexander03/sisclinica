...
function seleccionarServicioOtro(){
    ...
    $("#tbDetalle").append("<tr id='tr"+idservicio+"'><td><input type='hidden' id='txtIdTipoServicio"+idservicio+"' name='txtIdTipoServicio"+idservicio+"' value='0' /><input type='text' data='numero' class='form-control input-xs' id='txtCantidad"+idservicio+"' name='txtCantidad"+idservicio+"' style='width: 40px;' value='1' size='3' onkeydown=\"if(event.keyCode==13){calcularTotal()}\" onblur=\"calcularTotalItem2('"+idservicio+"')\" /></td>"+
        ...
        "<td align='center' style='display:none'><input type='text' size='5' readonly='readonly' style='width: 60px;' class='form-control input-xs' data='numero' id='txtDescuento"+idservicio+"' name='txtDescuento"+idservicio+"' value='0' onkeydown=\"if(event.keyCode==13){calcularTotalItem2('"+idservicio+"')}\" onblur=\"calcularTotalItem2('"+idservicio+"')\" style='width:50%' /></td>"+
...
function reprogramar() {
    ...
    console.log(fecha_reprogramar);
    if(fecha_reprogramar != ""){
        $.ajax({
            "method": "POST",
            "url": "{{ url('/ticket/reprogramar') }}",
            "data": {
                "ticket_id" : ticket_id, 
        ...
        alert('Escoja fecha de reprogramación');
    }
}
