        ...
        <div class="box-body">
            <table class="table table-condensed table-border" id="tbDetalle">
                <thead>
                    ...
                    <th class="text-center" colspan="2">Retencion</th>
                    <th class="text-center" colspan="2">Detraccion</th>
        ...
        $.ajax({
            ...
            success: function(a) {
                ...
                $("#tbDetalle").append("<tr id='tr"+datos[c].id+"'><td><input type='hidden' id='txtId"+datos[c].id+"' name='txtId"+datos[c].id+"' value='"+datos[c].id+"' />"+datos[c].fecha+"</td>"+
                    ...
                    "<td><input id='chkRetencion"+datos[c].id+"' type='checkbox' onclick='calcularRetencion(this.checked,"+datos[c].id+")' /></td>"+
                    ...
                    "<td><input type='checkbox' id='chkDetraccion"+datos[c].id+"' onclick='calcularDetraccion(this.checked,"+datos[c].id+")' /></td>"+
...
function calcularDetraccion(check,id){
    if(check){
        var det = Math.round((parseFloat($("#txtPrecio"+id).val())*0.12)*100)/100;
        $('#chkDetraccion'+id).prop('checked', true);
        //console.log($('#chkDetraccion'+id).prop('checked'));
    }else{
        var det = 0;
    }
...
function calcularRetencion(check,id){
    if(check){
        var ret = Math.round((parseFloat($("#txtPrecio"+id).val())*0.03)*100)/100;
        $('#chkRetencion'+id).prop('checked', true);
        //console.log($('#chkRetencion'+id).prop('checked'));
    }else{
        var ret = 0;
    }
