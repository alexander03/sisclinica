					...
					<div class="row">
						<div class="col-xs-12">
                            ...
                            <div class="form-group">
								...
								{!! Form::select('caja_id', $cboCaja, null, array('class' => 'form-control input-xs', 'id' => 'caja_id','onchange' => 'buscar(\''.$entidad.'\')')) !!}
							</div>
							<div class="form-group">
								{!! Form::label('formapago', 'Forma Pago:') !!}
								{!! Form::select('formapago', $cboFormapago, null, array('class' => 'form-control input-xs', 'id' => 'formapago','onchange' => 'buscar(\''.$entidad.'\')')) !!}
							</div>
							<div class="form-group">
								{!! Form::label('persona', 'Persona:') !!}
								{!! Form::text('persona', null, array('class' => 'form-control input-xs', 'id' => 'persona')) !!}
							</div>
							<div class="form-group">
                            ...
                            <div class="form-group">
								...
								{!! Form::text('area', null, array('class' => 'form-control input-xs', 'id' => 'area')) !!}
							</div>
							<div class="form-group">
                            ...
                            {!! Form::button('<i class="glyphicon glyphicon-file"></i> Excel2', array('class' => 'btn btn-success btn-xs', 'id' => 'btnExcel','onclick' => 'excel2();')) !!}
							{!! Form::close() !!}
						</div>
					</div>
				</div>
