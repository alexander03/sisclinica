...
{!! Form::model($historia, $formData) !!}	
    ...
    <div class="form-group">
		...
		<div class="col-lg-3 col-md-3 col-sm-3">
			{!! Form::select('departamento', $cboDepa, null, array('class' => 'form-control input-xs', 'id' => 'departamento')) !!}
		</div>
		{!! Form::label('provincia', 'Provincia:', array('class' => 'col-lg-2 col-md-2 col-sm-2 control-label')) !!}
		<div class="col-lg-3 col-md-3 col-sm-3">
			{!! Form::select('provincia', array('Elija Departamento'), null, array('class' => 'form-control input-xs', 'id' => 'provincia')) !!}
		</div>
	</div>
    <div class="form-group">
    	{!! Form::label('distrito', 'Distrito:', array('class' => 'col-lg-4 col-md-4 col-sm-4 control-label')) !!}
		<div class="col-lg-3 col-md-3 col-sm-3">
			{!! Form::select('distrito', array('Elija Provincia'), null, array('class' => 'form-control input-xs', 'id' => 'distrito')) !!}
		</div>
	</div>
	<div class="form-group">
