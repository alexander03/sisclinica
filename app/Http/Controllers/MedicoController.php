...
class MedicoController extends Controller
{
    ...
    public function buscar(Request $request)
    {
        ...
        $resultado        = Person::join('especialidad','especialidad.id','=','person.especialidad_id')
                            ->where('workertype_id','=','1')->where(DB::raw('CONCAT(apellidopaterno," ",apellidomaterno," ",nombres)'), 'LIKE', '%'.strtoupper($nombre).'%')->orderBy('apellidopaterno', 'ASC');
    ...
    {
        $resultado        = Person::join('especialidad','especialidad.id','=','person.especialidad_id')
                            ->where('workertype_id','=','1')->where(DB::raw('CONCAT(apellidopaterno," ",apellidomaterno," ",nombres)'), 'LIKE', '%'.strtoupper($searching).'%')->orderBy('apellidopaterno', 'ASC')
