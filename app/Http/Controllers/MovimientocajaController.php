...
{
    protected $folderview      = 'app.movimientocaja';
    protected $tituloAdmin     = 'Movimiento de Caja';
    ...
    protected $rutas           = array('create' => 'movimientocaja.create', 
            'edit'   => 'movimientocaja.edit', 
            'anular' => 'movimientocaja.anular',
            'search' => 'movimientocaja.buscar',
            'index'  => 'movimientocaja.index',
    ...
    public function index()
    {
        ...
        return view($this->folderview.'.admin')->with(compact('entidad', 'title', 'titulo_registrar', 'ruta','cboCaja', 'user'));
    }
