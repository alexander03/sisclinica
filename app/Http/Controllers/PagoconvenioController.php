        ...
        if (count($lista) > 0) {            
            ...
            foreach ($lista as $key => $value){$c=$c+1;
                ...
                if($value->servicio_id>0){
                    $pdf::Cell(122,6,($value->servicio),1,0,'L');
                }else{
                    $pdf::Cell(122,6,($value->servicio2),1,0,'L');
                }
