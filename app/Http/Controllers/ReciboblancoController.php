...
class ReciboblancoController extends Controller
{
    protected $folderview      = 'app.reciboblanco';
    protected $tituloAdmin     = 'Recibo Egreso';
    protected $tituloRegistrar = 'Registrar Recibo Egreso';
    protected $tituloModificar = 'Modificar Recibo Egreso';
    protected $tituloEliminar  = 'Eliminar Recibo Egreso';
    protected $rutas           = array('create' => 'reciboblanco.create', 
            'edit'   => 'reciboblanco.edit', 
            'delete' => 'reciboblanco.eliminar',
            'search' => 'reciboblanco.buscar',
            'index'  => 'reciboblanco.index',
    ...
    public function buscar(Request $request)
    {
        ...
        $resultado        = Movimiento::leftjoin('person as paciente', 'paciente.id', '=', 'movimiento.persona_id')
                            ...
                            ->where('movimiento.numero','LIKE','%'.$numero.'%')->where('movimiento.tipodocumento_id','=','14');
        if($fecha!=""){
    ...
    public function create(Request $request)
    {
        ...
        $entidad             = 'Reciboblanco';
        $reciboblanco = null;
        $formData            = array('reciboblanco.store');
        $numero = Movimiento::NumeroSigue(7,14);
    ...
    public function store(Request $request)
    {
        ...
        $error = DB::transaction(function() use($request,$user,&$dat){
            ...
            $Ticket->tipomovimiento_id=7;
            $Ticket->tipodocumento_id=14;
    ...
    public function eliminar($id, $listarLuego)
    {
        ...
        $entidad  = 'Reciboblanco';
        $formData = array('route' => array('reciboblanco.destroy'), 'method' => 'DELETE', 'class' => 'form-horizontal', 'id' => 'formMantenimiento'.$entidad, 'autocomplete' => 'off');
        $boton    = 'Eliminar';
    ...
    public function pdfRecibo(Request $request){
        ...
        $lista->tipomovimiento_id==14?$tipo="de Ingreso":$tipo="de Egreso";
        $pdf::Cell(50,10,utf8_decode("Recibo ".$tipo." Nro. ".$lista->numero),0,0,'C');
