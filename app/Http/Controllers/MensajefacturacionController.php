...
class MensajefacturacionController extends Controller
{
    ...
    public function buscar(Request $request)
    {
        ...
        $lista            = $resultado->orderBy('mensajefacturacion.fecha', 'DESC')->orderBy('hora','DESC')->select('mensajefacturacion.*','usuario.nombres as usuario')->get();
        $cabecera         = array();
    ...
    public function create(Request $request)
    {
        ...
        $boton    = 'Registrar'; 
        return view($this->folderview.'.mant')->with(compact('mensaje', 'formData', 'entidad', 'boton', 'listar', 'cboTipoPaciente'));
    }
