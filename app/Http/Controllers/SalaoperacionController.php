...
class SalaoperacionController extends Controller
{
    ...
    public function buscar(Request $request)
    {
        ...
        $resultado        = $resultado->select('Salaoperacion.*','usuario.nombres as usuario3','historia.tipopaciente','especialidad.nombre as especialidad','historia.numero as historia1',DB::raw('concat(paciente.apellidopaterno,\' \',paciente.apellidomaterno,\' \',paciente.nombres) as paciente2'),DB::raw('concat(doctor.apellidopaterno,\' \',doctor.apellidomaterno,\' \',doctor.nombres) as doctor'))->orderBy('Salaoperacion.fecha', 'ASC')->orderBy('Salaoperacion.horainicio','ASC');
        $lista            = $resultado->get();
        $cabecera         = array();
