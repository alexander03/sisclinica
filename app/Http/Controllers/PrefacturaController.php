...
class PrefacturaController extends Controller
{
    ...
    protected $rutas           = array('create' => 'prefactura.create', 
    ...
    public function buscar(Request $request)
    {
        ...
        $first1            = $first1->select('movimiento.id','movimiento.tipo','movimiento.listapago','movimiento.fecha','movimiento.numero',DB::raw('case when movimiento.persona_id>0 then concat(paciente.apellidopaterno,\' \',paciente.apellidomaterno,\' \',paciente.nombres) else movimiento.nombrepaciente end as paciente2'),DB::raw('responsable.nombres as responsable'),DB::raw('0 as servicio_id'),DB::raw('\'MEDICAMENTOS\' as servicio2'),DB::raw('\'MEDICAMENTOS\' as servicio'),'movimiento.total','historia.numero as historia',DB::raw('cast(conveniofarmacia.nombre as char(100)) as plan2'),'movimiento.copago','movimiento.tipodocumento_id',DB::raw('1 as cantidad'),DB::raw('-1 as tiposervicio_id'))->orderBy('movimiento.fecha', 'desc')->orderBy('movimiento.numero','ASC');
        ...
        $resultado        = $resultado->select('dmc.id',DB::raw('dmc.descargado as tipo'),DB::raw('dmc.observacion as listapago'),'movimiento.fecha','movimiento.numero',DB::raw('concat(paciente.apellidopaterno,\' \',paciente.apellidomaterno,\' \',paciente.nombres) as paciente2'),'responsable.nombres as responsable','dmc.servicio_id','dmc.descripcion as servicio2','s.nombre as servicio',DB::raw('dmc.cantidad*dmc.precio as total'),'historia.numero as historia','plan.nombre as plan2',DB::raw('0 as copago'),'movimiento.tipodocumento_id','dmc.cantidad',DB::raw('case when dmc.servicio_id>0 then s.tiposervicio_id else dmc.tiposervicio_id end as tiposervicio_id '))->orderBy('movimiento.fecha', 'ASC')->orderBy('movimiento.numero','ASC');
    ...
    public function excel(Request $request){
        ...
        $first1            = $first1->select('movimiento.id','movimiento.situacion','movimiento.tipo','movimiento.listapago','movimiento.fecha','movimiento.numero',DB::raw('case when movimiento.persona_id>0 then concat(paciente.apellidopaterno,\' \',paciente.apellidomaterno,\' \',paciente.nombres) else movimiento.nombrepaciente end as paciente2'),DB::raw('responsable.nombres as responsable'),DB::raw('0 as observacion'),DB::raw('0 as servicio_id'),DB::raw('\'MEDICAMENTOS\' as servicio2'),DB::raw('\'MEDICAMENTOS\' as servicio'),'historia.numero as historia',DB::raw('cast(conveniofarmacia.nombre as char(100)) as plan2'),'movimiento.copago','movimiento.tipodocumento_id')->orderBy('movimiento.fecha', 'desc')->orderBy('movimiento.numero','ASC');
        ...
        $resultado        = $resultado->select('movimiento.id','movimiento.situacion','dmc.descargado as tipo','movimiento.listapago','movimiento.fecha','movimiento.numero',DB::raw('concat(paciente.apellidopaterno,\' \',paciente.apellidomaterno,\' \',paciente.nombres) as paciente2'),'responsable.nombres as responsable','dmc.observacion','dmc.servicio_id','dmc.descripcion as servicio2','s.nombre as servicio','historia.numero as historia','plan.nombre as plan2',DB::raw('0 as copago'),'movimiento.tipodocumento_id')->orderBy('movimiento.fecha', 'ASC')->orderBy('movimiento.numero','ASC');
        $querySql = $resultado->unionAll($first1)->toSql();
        $binding  = $resultado->getBindings();
