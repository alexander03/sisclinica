...
Route::group(['middleware' => 'auth'], function () {
    ...
    //ANULAR MOVIMIENTO ALMACÉN

    Route::get('movimientoalmacen/anularmovimiento/{id}', 'MovimientoalmacenController@anularmovimiento')->name('movimientoalmacen.anularmovimiento');
   ...
   Route::post('facturacion/generarNumero', 'FacturacionController@generarNumero')->name('facturacion.generarNumero');
    ...
    Route::get('cartagarantia/eliminar/{id}', 'CartagarantiaController@eliminar')->name('cartagarantia.eliminar');
   ...
   Route::post('facturacionpasada/generarNumero', 'FacturacionpasadaController@generarNumero')->name('facturacionpasada.generarNumero');
    ...
    Route::get('caja/anularmovimiento/{id}', 'CajaController@anularmovimiento')->name('caja.anularmovimiento');
